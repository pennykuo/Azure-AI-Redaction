...
/**
 * Source: <a href="https://github.com/Azure/azure-sdk-for-java/blob/main/sdk/eventhubs/azure-messaging-eventhubs/src/samples/java/com/azure/messaging/eventhubs/SampleCheckpointStore.java">...</a>
 ...
 */
public class SimpleCheckpointStore implements CheckpointStore {
    ...
    private static final ClientLogger LOGGER = new ClientLogger(SimpleCheckpointStore.class);
